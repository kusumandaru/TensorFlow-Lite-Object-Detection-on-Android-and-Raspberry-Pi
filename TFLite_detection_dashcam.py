# USAGE
# python TFLite_detection_dashcam.py --modeldir=coco_tflite_model
# python TFLite_detection_dashcam.py --modeldir=coco_tflite_model --output example.avi --picamera 1
...
ap.add_argument("-o", "--output", default=str(millis)+'_output.avi',
